...
router.route('/telegram/user').post(validate('oauth', false), controller.tuser);
...
router.route('/telegram/send').post(validate('msg', false), controller.tsend);

router
  .route('/google/set_ban')
  .post(validate('setBan', false), googleOauth, controller.setBan);

router
  .route('/facebook/set_ban')
